                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="firstName"><g:message code="bio.firstName.label" default="First Name" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="lastName"><g:message code="bio.lastName.label" default="Last Name" /></label>
                                </td>
